...
1. INSERT two users:INSERT INTO users(first_name, last_name)VALUES ('test', 'user'), ('test2', 'user');


2. UPDATE all Ohio addresses to "REDACTED":UPDATE usersAddress SET state ='REDACTED' WHERE state= 'OH';
